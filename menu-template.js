    ...
    submenu: [
      ...
      (function() {
        ...
        if (active && (active.tagName === "INPUT" || active.tagName === "TEXTAREA")) {
          return; // skip if typing in search bar or any input
        }
        window.dispatchEvent(new Event("menu-play-pause"));
      })();
    `);
        },
      },
      ...
      (function() {
        const active = document.activeElement;
        if (active && (active.tagName === "INPUT" || active.tagName === "TEXTAREA")) {
          return; // skip if user typing in input
        }
        window.dispatchEvent(new Event("menu-fullscreen"));
      })();
    `);
        },
      },
